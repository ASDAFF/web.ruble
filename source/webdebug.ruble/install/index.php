...
Class webdebug_ruble extends CModule {
	...
	function DoInstall() {
		...
		RegisterModuleDependences('main','OnEndBufferContent','webdebug.ruble',"CWebdebugRuble", "OnEndBufferContent");
	...
	function DoUninstall() {
		...
		UnRegisterModuleDependences('main','OnEndBufferContent','webdebug.ruble',"CWebdebugRuble", "OnEndBufferContent");
